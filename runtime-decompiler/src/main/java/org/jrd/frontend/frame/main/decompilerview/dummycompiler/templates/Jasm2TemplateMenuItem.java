...
public class Jasm2TemplateMenuItem extends JMenuItem {
    public Jasm2TemplateMenuItem(final RSyntaxTextArea source) {
        super("jasm swing hello with dependence example");
