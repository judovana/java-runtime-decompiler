...
public class AgentLoader {
    ...
    public int attach(int pid) {
        ...
        OutputController.getLogger().log(OutputController.Level.MESSAGE_DEBUG, new RuntimeException("Attempting to attach decompiler agent for VM '" + pid + "' on port '" + port + "'"));
