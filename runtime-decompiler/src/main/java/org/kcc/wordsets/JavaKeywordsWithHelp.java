...
public class JavaKeywordsWithHelp  implements  CompletionItem.CompletionItemSet{
    private static final CompletionItem[] JAVA_KEYWORDS = {
            ...
            new CompletionItem("boolean", "Defines a boolean variable for the values \"true\" or \"false\" only. By default, the value of boolean primitive type is false. This keyword is also used to declare that a method returns a value of the primitive type boolean."),
            new CompletionItem("break", "Used to end the execution in the current loop body. Used to break out of a switch block."),
            new CompletionItem("byte", "The byte keyword is used to declare a field that can hold an 8-bit signed two's complement integer.[5][6] This keyword is also used to declare that a method returns a value of the primitive type byte.[7][8]"),
            new CompletionItem("case", "A statement in the switch block can be labeled with one or more case or default labels. The switch statement evaluates its expression, then executes all statements that follow the matching case label; see switch.[9][10]"),
            new CompletionItem("catch", "Used in conjunction with a try block and an optional finally block. The statements in the catch block specify what to do if a specific type of exception is thrown by the try block."),
            new CompletionItem("char", "Defines a character variable capable of holding any character of the java source file's character set."),
            ...
            new CompletionItem("continue", "Used to resume program execution at the end of the current loop body. If followed by a label, continue resumes execution at the end of the enclosing labeled loop body."),
            new CompletionItem("default", "The default keyword can optionally be used in a switch statement to label a block of statements to be executed if no case matches the specified value; see switch.[9][10] Alternatively, the default keyword can also be used to declare default values in a Java annotation. From Java 8 onwards, the default keyword can be used to allow an interface to provide an implementation of a method."),
            ...
            new CompletionItem("double", "The double keyword is used to declare a variable that can hold a 64-bit double precision IEEE 754 floating-point number.[5][6] This keyword is also used to declare that a method returns a value of the primitive type double.[7][8]"),
            new CompletionItem("else", "The else keyword is used in conjunction with if to create an if-else statement, which tests a boolean expression; if the expression evaluates to true, the block of statements associated with the if are evaluated; if it evaluates to false, the block of statements associated with the else are evaluated.[13][14]"),
            ...
            new CompletionItem("float", "The float keyword is used to declare a variable that can hold a 32-bit single precision IEEE 754 floating-point number.[5][6] This keyword is also used to declare that a method returns a value of the primitive type float.[7][8]"),
