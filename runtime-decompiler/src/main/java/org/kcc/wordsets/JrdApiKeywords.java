...
public class JrdApiKeywords implements CompletionItem.CompletionItemSet {
    ...
    private static final CompletionItem[] BASE_JRDAPI_KEYWORDS = new CompletionItem[]{new CompletionItem(
            ...
            new CompletionItem("(Object)(org.jrd.agent.api.Variables.Local.set(Object, String, Object));", INTRO + LOCAL + SAFE +
            ...
            INTRO + LOCAL + SAFE + "Will set the variable/method of String name to instance of Object (first param) to value of " +
                    ...
                    "variable/method is already set. Returns freshly inserted value."), new CompletionItem(
            "(String)(org.jrd.agent.api.Variables.Local.dump());",
            "Will dump to String all safe, local variables/methods currently declared"), new CompletionItem(
            ...
            new CompletionItem("org.jrd.agent.api.Variables.Local.destroy();",
                    "Will remove all safe, local variables/methods currently declared"), new CompletionItem(
            "org.jrd.agent.api.Variables.Local.removeAll(Object);",
            "Will remove all safe, local variables/methods bound to given Object"), new CompletionItem(
            ...
            INTRO + GLOBAL + SAFE + "get the value of stored global field/method of String name" +
                    "). Will throw NoSuchFakeVariableException if that variable " + "do not already exists."), new CompletionItem(
            ...
            INTRO + GLOBAL + SAFE + "Will dump to String all safe, global variables/methods currently declared"), new CompletionItem(
            "org.jrd.agent.api.Variables.Global.removeAll();",
            INTRO + GLOBAL + SAFE + "Will remove all safe, global variables/methods." +
                    "It is moreover equal to destroy method of Clazzs anf Locals."), new CompletionItem(
            ...
            new CompletionItem("(Object)(org.jrd.agent.api.Variables.Clazzs.create(String, Object));",
                    INTRO + CLAZZS + SAFE + CLAZZS_FINAL + CLAZZS_UNBOUND), new CompletionItem(
            ...
            new CompletionItem("(Object)(org.jrd.agent.api.Variables.Clazzs.get(Class, String));",
                    INTRO + CLAZZS + SAFE + CLAZZS_FINAL), new CompletionItem(
            ...
            INTRO + CLAZZS + SAFE + CLAZZS_FINAL), new CompletionItem("(String)(org.jrd.agent.api.Variables.Clazzs.dump());",
            INTRO + CLAZZS + SAFE + CLAZZS_FINAL), new CompletionItem("(String)(org.jrd.agent.api.Variables.Clazzs.dump(Class...));",
            INTRO + CLAZZS + SAFE + CLAZZS_FINAL), new CompletionItem("org.jrd.agent.api.Variables.Clazzs.destroy();",
            INTRO + CLAZZS + SAFE + CLAZZS_FINAL), new CompletionItem("org.jrd.agent.api.Variables.Clazzs.removeAll();",
            INTRO + CLAZZS + SAFE + CLAZZS_FINAL), new CompletionItem("org.jrd.agent.api.Variables.Clazzs.removeAll(Class);",
            INTRO + CLAZZS + SAFE + CLAZZS_FINAL), new CompletionItem("org.jrd.agent.api.Variables.Clazzs.removeAll(String);",
            INTRO + CLAZZS + SAFE + CLAZZS_FINAL + "This calls classForName on String."), new CompletionItem(
            ...
            new CompletionItem("(Object)(org.jrd.agent.api.UnsafeVariables.Local.get(Object, String));", UNSAFE), new CompletionItem(
            "(Object)(org.jrd.agent.api.UnsafeVariables.Local.getOrCreate(Object, String, Object));", UNSAFE), new CompletionItem(
            ...
            "org.jrd.agent.api.UnsafeVariables.Clazzs.removeAll(Class);", UNSAFE), new CompletionItem(
